...
RESULT_PATH_FR2="../../results/orb/tum_rgbd_$i/rgbd_dataset_freiburg2_xyz"
...
RESULT_PATH_FR3="../../results/orb/tum_rgbd_$i/rgbd_dataset_freiburg3_long_office_household"
