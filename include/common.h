...
#include <photo_slam/SaveMap.h> // This file is created automatically, see here http://wiki.ros.org/ROS/Tutorials/CreatingMsgAndSrv#Creating_a_srv
...
bool save_map_srv(photo_slam::SaveMap::Request &,
                  photo_slam::SaveMap::Response &);
bool save_traj_srv(photo_slam::SaveMap::Request &,
                   photo_slam::SaveMap::Response &);
